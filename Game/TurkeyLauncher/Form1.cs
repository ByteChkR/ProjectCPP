...
namespace TurkeyLauncher
{
    ...
    public partial class frmLauncher : Form
    {
        ...
        public frmLauncher()
        {
            ...
            if(System.IO.File.Exists("mge/textures/banner.png"))
            {
                pbBanner.Image = System.Drawing.Bitmap.FromFile("mge/textures/banner.png");
            }

            if (!System.IO.File.Exists("mge.exe"))
            {
        ...
        void InitializeADL()
        {
            ...
            adlConsole = (CustomCMDForm)CMDUtils.CreateCustomConsole(ps);
        ...
        void StartEngine(string args)
        {
            ...
            System.Diagnostics.ProcessStartInfo psi = new System.Diagnostics.ProcessStartInfo("mge.exe", args);
        ...
        void CompileLuaEngineSettings(int width, int height, int msaaSamples, bool vSync, bool windowMode)
        {
            ...
            if (System.IO.File.Exists("mge/enginesettings.lua"))
                System.IO.File.Delete("mge/enginesettings.lua");

            System.IO.TextWriter tw = new System.IO.StreamWriter("mge/enginesettings.lua");
            try
            {
        ...
        {
            string ret = "";
            if (cbWindowed.Checked) ret += "-forceWindow";
        ...
        void InvalidateUserMapLists()
        {
            ...
            if (System.IO.Directory.Exists("mge/customMapLists/"))
            {
                foreach (string s in System.IO.Directory.GetFiles("mge/customMapLists/", "*.lua"))
                {
