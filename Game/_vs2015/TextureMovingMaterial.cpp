...
float TextureMovingMaterial::textureXOffset = 0.4;
...
void TextureMovingMaterial::render(int pass, World* pWorld, Mesh* pMesh, const glm::mat4& pModelMatrix, const glm::mat4& pViewMatrix, const glm::mat4& pProjectionMatrix) {
	...
	glm::vec3 ppos = PlayerController::instance->_hasShadow ? PlayerController::instance->getOwner()->getLocalPosition(): glm::vec3(100);
